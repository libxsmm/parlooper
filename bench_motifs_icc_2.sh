...
#Convs
bash RN50_parlooper_graviton3_bench.sh 16 16 8 2 > RN50_mb16_thr16
cat RN50_mb16_thr16 | grep GFLOPS | cut -d' ' -f2
...
#MB=256
./gemm "aCB" 512 256 512 32 32 32 1 400 100  > mlp_256_mb_bench
./gemm "aCB" 1024 256 1024 32 32 32 1 160 100>> mlp_256_mb_bench
